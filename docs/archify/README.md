# image-pipes Archify Architecture
...
- Repository URL: https://github.com/hundong2/image-pipes.git
- Checkout SHA: fded0b8cc05279524c8f7494891203bdbb124bca
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: 🎨 Image Pipes
- Dependency markers: JS/TS
- Top-level directories: .cursor, backend, desktop, docs, frontend, guide, scripts
- Category: OCR, document, and media AI

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for image-pipes.
